...
--	EXECUTE IMMEDIATE 'TRUNCATE TABLE ETL_DIM_TIEMPO';
    INSERT INTO PSTAR.DIM_TIEMPO (FECHA,DIA,DIA_SEMANA,DIA_LABORAL,DIA_FERIADO,MES,MES_CADENA,PERIODO,TRIMESTRE,SEMESTRE,ANIO)
    SELECT                      FECHA,DIA,DIA_SEMANA,DIA_LABORAL,DIA_FERIADO,MES,MES_CADENA,PERIODO,TRIMESTRE,SEMESTRE,ANIO
