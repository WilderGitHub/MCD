CREATE OR REPLACE PROCEDURE ETL_STG_ORDERDETAILS IS

  V_NOMBRE_PROCESO   VARCHAR2(30):= 'ETL_STG_ORDERDETAILS';
  V_FEC_INICIO       DATE;
  V_FEC_FIN          DATE;
...
BEGIN
  ...
  -- CODIGO DEL PROCESO
    ...
    EXECUTE IMMEDIATE 'TRUNCATE TABLE STG_ORDERDETAILS';
    ...
    SELECT * FROM PEDIDOS.ORDERDETAILS;
